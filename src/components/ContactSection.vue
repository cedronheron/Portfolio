<template>
  <section id="contact" class="glass-panel p-8 card-hover">
    <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-6">
      <div>
        ...
        <h2 class="text-3xl font-semibold mt-3">Tell me about your project</h2>
        <p class="text-slate-300 mt-2">I respond within 24 hours with next steps and availability.</p>
      </div>
      ...
      <div class="text-sm text-slate-300 flex items-center gap-2 mt-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <form class="grid md:grid-cols-2 gap-4" @submit.prevent="submitForm">
      ...
      <label class="md:col-span-2 space-y-2 text-sm text-slate-200">
        Project details
        <textarea
      ...
      <div class="md:col-span-2 flex items-center justify-between">
        <div class="text-sm text-slate-400">No spam. Form posts to Formspree and tracks locally.</div>
        <button
          type="submit"
    ...
    <p v-if="formStatus === 'sent'" class="text-sm text-emerald-400 mt-3">Thanks! I will reach out shortly.</p>
    <p v-if="formStatus === 'error'" class="text-sm text-amber-400 mt-3">Something went wrong. Please email me directly.</p>
  </section>
</template>
